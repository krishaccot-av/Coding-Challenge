...
2.  Clone [https://github.com/krishaccot-av/chips-input](https://github.com/krishaccot-av/Coding-Challenge.git)  code to local machine. 
3. Open Visual Studio Code poiting the cloned code folder.
